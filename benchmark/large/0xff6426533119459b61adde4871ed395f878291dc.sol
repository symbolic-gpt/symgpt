...
// File contracts/DEFI721.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.9;

contract DEFI721 is ERC721, Ownable, ERC721Enumerable {
	using Counters for Counters.Counter;

	Counters.Counter private _tokenIdCounter;
	string public baseURI;
	address public DAPP_CONTRACT;
	...
	modifier onlyAuth() {
		require(
			msg.sender == DAPP_CONTRACT || msg.sender == owner(),
			"Unauthorized user"
		);
		_;
	}

	function setDappContract(address _dappContract) external onlyOwner {
		DAPP_CONTRACT = _dappContract;
	}
	...
	function safeMint(address to) external onlyAuth returns (uint256 _tokenId) {
