...
// File: contracts/leesungyong.sol
...
contract Leesungyong is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    
    mapping(address => bool) public Frozen;

    constructor(address initialOwner)
        ERC20("leesungyong", "LSY")
        Ownable(initialOwner)
        ERC20Permit("leesungyong")
    {
