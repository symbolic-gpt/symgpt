...
/// @custom:security-contact wheecoin@gmx.com
contract WHEECoin is ERC20, ERC20Permit, Ownable {
    constructor(address initialOwner)
        ERC20("WHEE Coin", "WHEE")
        ERC20Permit("WHEE Coin")
