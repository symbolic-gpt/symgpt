...
// File: contracts/wAVN.sol


// Wrapped Avian is an ERC20 token with additional features like access control and pausability
pragma solidity ^0.8.0;
...
contract WrappedAVN is ERC20, AccessControl, Pausable, EIP712 {
    ...
    constructor() 
        ERC20("Wrapped Avian", "wAVN") 
        EIP712("WrappedAvian", "1") 
    {
