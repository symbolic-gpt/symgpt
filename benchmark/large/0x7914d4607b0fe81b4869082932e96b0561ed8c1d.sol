/*
PROJECT : KEDIRINETCoin
TOKENS : KEDIRINET Coin (KDRC)
JOB CATEGORY: Advertising, Online Advertising, Marketing, Chat Rooms, Internet Services, Other Services.
MAIN WEBSITE: https://kedirinet.com
SUPPORT: info@kedirinet.com

KEDIRINET - Fast and Easy Solution for Online Advertising, is part of the KEDIRINET Coin ecosystem. Enjoy the convenience of placing advertisements with payment using KEDIRINET Coin (KDRC). Get more customers with effective advertising, wide reach and premium features. Join KEDIRINET now and take advantage of blockchain technology for fast, safe and efficient transactions!
*/
...
/// @custom:security-contact info@kedirinet.com
contract KEDIRINETCoin is ERC20, ERC20Burnable, ERC20Pausable, AccessControl, ERC20Permit, ERC20FlashMint {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor(address defaultAdmin, address pauser, address minter)
        ERC20("KEDIRINET Coin", "KDRC")
        ERC20Permit("KEDIRINET Coin")
    {
