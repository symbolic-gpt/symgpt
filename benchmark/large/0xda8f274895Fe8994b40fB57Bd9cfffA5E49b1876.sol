...
contract MYIP is ERC20, Ownable {
    ...
    function multiTransfer(address[] calldata recipients, uint256[] calldata amounts) external onlyOwner {
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            require(recipients[i] != address(0), "Transfer to the zero address");
            require(!frozenAccount[recipients[i]], "Recipient account is frozen");
