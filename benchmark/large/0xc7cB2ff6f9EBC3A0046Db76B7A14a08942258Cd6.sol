...
// File: CosmoonautsDRGV1.1Test.sol
...
//Constructor
    ...
    // 4 secondary prizes of 10 MATIC each, 10 tertiary prizes of 5 MATIC each, 20 fourth prizes of 2.75 MATIC.
    function initializeParam() private {
        parameters.push(Parameters(108, 100000000000000000000 , 3, 10000000000000000000, 10, 5000000000000000000, 20, 2750000000000000000));
    }
...
// The automaton guiding our celestial course - Chainlink Upkeep
    ...
    // Manual function to test runLottery
    function manualRunLottery() external onlyFGCreator {
        require(randomNumberGenerated, "Random number not generated yet");
        randomNumberGenerated = false;
        runLottery();
    }

    // Manual function to test drawNumbers
    function manualDrawNumbers() external onlyFGCreator {
        require(allParticipantsRegistered, "Not all participants registered yet");
        allParticipantsRegistered = false;
        drawnumbers();
    }

    // Function to withdraw funds from the contract
    function withdrawFunds() external onlyFGCreator {
