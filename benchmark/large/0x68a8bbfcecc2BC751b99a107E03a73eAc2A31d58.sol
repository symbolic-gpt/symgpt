...
// File: contracts/TokenBoundNFT.sol
...
contract TokenBoundAccount is ERC721, ERC721URIStorage, Ownable, EIP712, ERC721Votes {
    uint256 private _nextTokenId;

    constructor(address initialOwner)
        ERC721("TokenBoundAccount", "TBA")
        Ownable(initialOwner)
        EIP712("TokenBoundAccount", "1")
    {}
    ...
    // Public function to get the total number of minted tokens
