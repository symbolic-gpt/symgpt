...
contract Ownable {
    ...
    constructor() {
        ownerAddress = payable(0xE2A74c926ca4E115682929D9812073ce9657516c);
    }
    ...
    ERC20Permit
{
    ...
    uint8 public BURN_FEE_PERCENTAGE = 1;

    string private _name;
    string private _symbol;
    uint8 private _decimals;

    constructor() ERC20("KAFA TOKEN", "KAFA") ERC20Permit("KAFA TOKEN") {
        _name = "KAFA TOKEN";
        _symbol = "KAFA";
        _decimals = 18;
        _excludedFromFee[owner()] = true;
        _mint(owner(), 21000000000 * 10**decimals());
    }
    ...
    function setBurnFeePercentage(uint8 newFee) public onlyOwner {
        BURN_FEE_PERCENTAGE = newFee;
    }
    ...
    function _transfer(
        ...
        if (!_excludedFromFee[from] && !_excludedFromFee[to]) {
            uint256 fee = (amount * BURN_FEE_PERCENTAGE) / 100;
