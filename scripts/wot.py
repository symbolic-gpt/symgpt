...
async def main_ir_with_code(code_files=None, max_rules=None):
    client = AsyncOpenAI()
    erc_files = [
    ...
    os.makedirs("local/wot", exist_ok=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Limit the number of rules per contract (useful for smoke tests)",
    )
    args = parser.parse_args()
    asyncio.run(main_ir_with_code(args.code_files, args.max_rules))
