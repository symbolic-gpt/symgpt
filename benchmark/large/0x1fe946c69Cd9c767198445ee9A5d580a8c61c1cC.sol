...
/*
Based on the famous 50Cent song "Many Men" wish death on Trump
They try to kill him but he lives stronger. 50Trump. 
https://manymen.lol/
https://t.me/FiftyTrump
https://x.com/50TrumpX
*/
...
contract Manymen is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Many Men";
    string private constant _symbol = unicode"50TRUMP";
    ...
    function go_LimitsOff() external onlyOwner{
