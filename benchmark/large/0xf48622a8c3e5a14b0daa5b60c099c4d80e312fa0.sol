...
contract ERC20CA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Maxwell Yearick";
    string private constant _symbol = unicode"RIPMAX";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x868C2fFAC80A758A9ecB2A45F34ECbb386d00AEc);
