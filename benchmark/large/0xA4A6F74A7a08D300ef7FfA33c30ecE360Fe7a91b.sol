...
contract Y8uDistributor is Ownable, ReentrancyGuard {
    ...
    constructor() Ownable(0xF7E6abcEd1f5aCE75a660B4e98b6347047f7081B) {
        y8u = new Y8uERC20();

        // mint public sale
        y8u.mint(0xF7E6abcEd1f5aCE75a660B4e98b6347047f7081B, PUBLIC_SALE);

        // mint liquidity, exchanges, MM
        y8u.mint(0xF7E6abcEd1f5aCE75a660B4e98b6347047f7081B, LIQUIDITY_EXCHANGES_MM);
    }
