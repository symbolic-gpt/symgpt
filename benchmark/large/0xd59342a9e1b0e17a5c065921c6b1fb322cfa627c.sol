//IMPERATOR PEPE - ON ETHEREUM

//WEBSITE - https://imperatorpepe.site/

//TELEGRAM - https://t.me/IMPERATORPEPEPORTAL

//X - https://x.com/ImperatorPepe
...
contract ImpPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Imperator Pepe";
    string private constant _symbol = unicode"ImpPepe";
    uint256 public _maxTxAmount = 8413800000 * 10**_decimals;
    uint256 public _maxWalletSize = 8413800000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 8413800000 * 10**_decimals;
    uint256 public _maxTaxSwap= 2524140000 * 10**_decimals;
    ...
    function uniqueFunction() public pure returns (int num) {
        return 1;
    }
