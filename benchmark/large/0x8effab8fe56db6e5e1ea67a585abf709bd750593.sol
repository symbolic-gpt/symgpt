...
/*
    _              _                             _          
   / \   _ __   __| |_   _ _ __   ___  _ __ ___ (_) ___ ___ 
  / _ \ | '_ \ / _` | | | | '_ \ / _ \| '_ ` _ \| |/ __/ __|
 / ___ \| | | | (_| | |_| | | | | (_) | | | | | | | (__\__ \
/_/   \_\_| |_|\__,_|\__, |_| |_|\___/|_| |_| |_|_|\___|___/
                     |___/                                  
*/
...
contract andynomics is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ANDYNOMICS";
    string private constant _symbol = unicode"ANDYNOMICS";
