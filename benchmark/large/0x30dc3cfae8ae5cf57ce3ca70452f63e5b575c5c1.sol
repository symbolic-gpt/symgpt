...
contract mc is ERC721A, Ownable {
    address _owner = 0xAa0f2a9d76f85151826A41d4C2462De2Ca05E0bA;
    ...
    constructor(string memory _name, string memory _symbol, string memory _revealedURI)
    ...
    function publicMint(uint256 quantity) external payable {
        ...
        require(msg.value >= tokenPrice * quantity, "Insufficient Ether sent");
