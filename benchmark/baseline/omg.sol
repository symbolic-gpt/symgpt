...
contract PausableToken is StandardToken, Pausable {
    function transfer(address _to, uint _value) public virtual override(BasicToken, ERC20Basic) whenNotPaused {
...
contract OMGToken is PausableToken, MintableToken {
    ...
    function transfer(address _to, uint _value) public override(BasicToken, ERC20Basic, PausableToken) {
        super.transfer(_to, _value);
    }

    function transferFrom(address _from, address _to, uint _value) public override(StandardToken, PausableToken) {
        super.transferFrom(_from, _to, _value);
    }
}
