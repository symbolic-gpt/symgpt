...
contract PirateLion is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("Pirate Lion", "PIL")
        Ownable(initialOwner)
        ERC20Permit("Pirate Lion")
    {
