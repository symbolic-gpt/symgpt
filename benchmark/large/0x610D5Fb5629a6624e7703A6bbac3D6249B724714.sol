...
// File: contracts/Y8uDistributor.sol
...
contract Y8uDistributor is Ownable, ReentrancyGuard {
    ...
    constructor() Ownable(0x29c4c9a675A4A2DAED00c6325A8358F4ca7df53E) {
        y8u = new Y8uERC20(address(this));

        // mint public sale
        y8u.mint(0x29c4c9a675A4A2DAED00c6325A8358F4ca7df53E, PUBLIC_SALE);

        // mint liquidity, exchanges, MM
        y8u.mint(0x29c4c9a675A4A2DAED00c6325A8358F4ca7df53E, LIQUIDITY_EXCHANGES_MM);
    }
