...
// File: contract-fd7080c456.sol

/*
Our goal is to build a strong and sustainable ecosystem supported by payments using DEVY Token.
*/
...
/// @custom:security-contact info@devy.biz.id
contract DEVYANTI_SAPUTRA is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("DEVY", "DEVY")
