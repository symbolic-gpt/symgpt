...
abstract contract LutTokenInterface is ERC20 {
    bool public freeze;

    function burn(uint256 _value) public virtual;

    function setSale(address _sale) public virtual;

    function thaw() external virtual;
}
...
contract LutToken is
    ...
    Pausable
{
    function burn(uint256 _value) public override(LutTokenInterface, BurnableToken) {
...
whenNotPaused saleOrUnfrozen returns (bool) {
...
whenNotPaused saleOrUnfrozen returns (bool) {
    ...
    function setSale(address _sale) public override onlyOwner {
        frozen = true;
        sale = _sale;
    }
    ...
    function thaw() external override onlySale {
        frozen = false;
    }
}
