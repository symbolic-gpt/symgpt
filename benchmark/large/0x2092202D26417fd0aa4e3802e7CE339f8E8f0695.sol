...
// File: simTokenV2/simpsonToken.sol
...
// File: simTokenV2/polygonBridge.sol


// Compatible with OpenZeppelin Contracts ^5.0.0

// Bridge for sendig Simpson Token To Ethereum and Binance Networks.
// This bridge secure by CCIP
...
contract SimpsonToken is CCIPReceiver,Simpsons {

    address immutable public _CCIP_Router = 0x849c5ED5a80F5B408Dd4969b78c2C8fdf0565Bfe;
    address immutable public _Link_Token = 0xb0897686c545045aFc77CF20eC7A532E3120E0F1;
    ...
    function _ccipReceive(
        ...
        require(message.sourceChainSelector == ethChainSelector || message.sourceChainSelector == bnbChainSelector, "This Chain not Supported");
    ...
    function safeTransferToEthereum(uint256 value) public payable  {
        sendCCIP(ethChainSelector,msg.sender,value);
    }
    function safeTransferToBinance(uint256 value) public payable  {
        sendCCIP(bnbChainSelector,msg.sender,value);
    }

    function transferToEthereum(address recipient,uint256 value) public payable  {
        sendCCIP(ethChainSelector,recipient,value);
    }
    function transferToBinance(address recipient,uint256 value) public payable  {
        sendCCIP(bnbChainSelector,recipient,value);
    }

    function transferToEthereumFee() public view returns (uint256 Fee)  {
        Fee = crossTransferFee (ethChainSelector,  false);
    }
    ...
    function sendCCIP(uint64 targetSelector,address to, uint256 value) internal{
        ...
        Client.EVM2AnyMessage memory message = Client.EVM2AnyMessage({
            ...
            extraArgs: Client._argsToBytes(
                Client.EVMExtraArgsV1({gasLimit: 50_000})
            ),
