...
contract xEuro {
    ...
    function transferFrom(
        ...
        if (_to == address(this) && _value > 0) {
            ...
            tokensInTransfer[tokensInEventsCounter].receivedOn = block.timestamp;
    ...
    event minExchangeAmountChanged(
        address indexed by,
        uint256 from,
        uint256 to
    ); //
    ...
    event AddressRemovedFromCanMint(
        address indexed by,
    ...
    event AddressAddedToCanTransferFromContract(
        address indexed by,
    ...
    event AddressRemovedFromCanTransferFromContract(
        address indexed by,
        address indexed removedAddress
    ); //
    ...
    event AddressRemovedFromCanBurn(
        address indexed by,
        address indexed removedAddress
    ); //
