/*
Telegram: https://t.me/Shinobi_ERC20
Website: http://www.shinobierc20.xyz
X: https://x.com/Shinobi_ERC20
*/
...
contract Shinobi is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"SHINOBI";
    ...
    uint256 private  _tTotal = 9999999 *10**_decimals;
    ...
    function excludeFromFees(address _account, bool state) public onlyOwner {
    ...
    function addMaxWalletSize(address _account, uint256 amount) external onlyOwner {
