...
/// @custom:security-contact email@slxuniverse.com
contract FARTCoin is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("FART Coin", "FART")
        Ownable(initialOwner)
        ERC20Permit("FART Coin")
    {
        _mint(msg.sender, 101000000000 * 10 ** decimals());
    }
