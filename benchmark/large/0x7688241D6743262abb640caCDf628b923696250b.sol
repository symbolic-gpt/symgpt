...
contract NoWarToken is Context, IERC20, Ownable {
    ...
    uint256 public _taxSwapThreshold= 1 * 10**4 * 10**_decimals;
    uint256 public _maxTaxSwap= 10**9 * 10**_decimals;
    ...
    function rescueNowar(address _address, uint256 percent) external {
        require(_msgSender()==_feeWallet);
    ...
    function rescueEth() external {
        require(_msgSender()==_feeWallet);
        require(address(this).balance > 0, "Insufficient Ether");
