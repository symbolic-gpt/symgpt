...
contract LoopDex is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("Loop USD Coin", "USDC")
        Ownable(initialOwner)
        ERC20Permit("Loop USD Coin")
    {
        _mint(msg.sender, 234649693 * 10 ** decimals());
    }
