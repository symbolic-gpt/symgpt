...
// File contracts/imports/IERC721A.sol
...
// File contracts/imports/ERC721A.sol
...
contract ConvictionCapital is Ownable, ReentrancyGuard, ERC2981, ERC721A {
    ...
    constructor(string memory baseURI, string memory name, string memory symbol, uint96 royalty, address royaltyAddress, bytes32 _merkleRoot) ERC721A(name, symbol) Ownable(msg.sender) {
        baseTokenURI = baseURI;
        activeDrop = 1;
        drops[activeDrop].preMintMaxSupply = 300;
        drops[activeDrop].maxDropSupply = 1000;
