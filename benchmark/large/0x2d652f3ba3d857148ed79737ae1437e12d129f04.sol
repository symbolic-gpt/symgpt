...
// File contracts/BelieverOne.sol

// contracts/BelieverOne.sol  
// Original license: SPDX_License_Identifier: MIT
...
contract BelieverOne is ERC20, AccessControl, ERC20Permit {
    uint256 private constant MAX_SUPPLY = 333 * (10 ** 6); // Maximum supply: 333 tokens
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE"); //Asing the role 
    ...
    constructor(uint256 initialSupply)
        ERC20("BelieverOne", "BeeOn")
        ERC20Permit("BelieverOne")
    {
        // Ensure the initial supply does not exceed the maximum supply
        require(initialSupply <= MAX_SUPPLY, "Initial supply exceeds maximum supply");

        // Assign the DEFAULT_ADMIN_ROLE and MINTER_ROLE to the deployer
    ...
    /**
     * @dev Override the decimals function to return 6 decimals.
     * @return uint8 Number of decimals for the token.
     */
    function decimals() public view virtual override returns (uint8) {
        return 6; // Ensure the token uses 6 decimals
    }

    /**
     * @dev Mint function that allows minting of new tokens.
