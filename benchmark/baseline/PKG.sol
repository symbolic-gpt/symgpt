...
contract ICOToken is BaseToken {
    ...
    fallback() external payable onlyBefore {
...
contract CustomToken is BaseToken, BurnToken, ICOToken {
    constructor()  {
        ...
        balanceOf[address(0x008cd103c2164d04d071f4014ac7b3aa42d8fa596c)] = totalSupply;
        name = "PKG Token";
        symbol = "PKG";
        decimals = 18;
        icoRatio = 100000;
        icoEndtime = 1601460000;
        icoSender = address(0x008cd103c2164d04d071f4014ac7b3aa42d8fa596c);
        icoHolder = payable(address(0x008cd103c2164d04d071f4014ac7b3aa42d8fa596c));
    }
}
