...
// File: contracts/TilekCoin.sol


// A birthday gift to Tilek from Omur and Eldar)
...
contract TilekCoin is ERC20, ERC20Burnable, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor(address defaultAdmin, address minter)
        ERC20("TilekCoin", "TILEK")
    {
        _grantRole(DEFAULT_ADMIN_ROLE, defaultAdmin);
        _grantRole(MINTER_ROLE, minter);
    }

    function distributeRewards(address[] memory receivers, uint[] calldata amounts) public onlyRole(MINTER_ROLE) returns(bool) {
