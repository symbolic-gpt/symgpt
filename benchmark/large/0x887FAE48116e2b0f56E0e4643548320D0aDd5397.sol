...
/// @custom:security-contact info@coin-clash.com
contract Memories is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Memories", "PPGMemories") {}


    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmTo3ZeR2ENkXf8UfbA9R89mnvrfbn31uBD1L97JB7bNce";
    }
    ...
    function safeMint(address to) public onlyOwner {
        ...
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, "https://gateway.pinata.cloud/ipfs/QmTo3ZeR2ENkXf8UfbA9R89mnvrfbn31uBD1L97JB7bNce");
    }
