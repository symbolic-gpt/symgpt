...
contract CornstarOfficial is ERC20, ERC20Burnable, ERC20Permit {
    constructor()
        ERC20("Cornstar Official", "CORN")
        ERC20Permit("Cornstar Official")
    {
        _mint(msg.sender, 111111111111 * 10 ** decimals());
    }
}