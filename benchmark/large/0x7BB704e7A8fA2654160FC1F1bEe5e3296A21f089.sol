...
// File: AnabulToken.sol

/***
PROJECT : Anabul Token
SUPPLAY : 10 000 000 000
WEB OFFICE : https://anabul.my.id

FUR ANIMAL LOVERS COMMUNITY TOKEN
Crypto Tokens Aimed At Animal Loving Communities. Serves As A Tool To Facilitate Transactions Within The Community Ecosystem. This Type Of Token Can Be Used For Various Purposes
***/
...
/// @custom:security-contact support@anabul.my.id
contract AnabulToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("Anabul", "ABL")
