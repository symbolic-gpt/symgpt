...
// File: @openzeppelin/contracts@5.0.2/access/manager/IAuthority.sol
...
// File: @openzeppelin/contracts@5.0.2/access/manager/AuthorityUtils.sol
...
// File: @openzeppelin/contracts@5.0.2/access/manager/IAccessManaged.sol
...
// File: @openzeppelin/contracts@5.0.2/access/manager/IAccessManager.sol
...
// File: @openzeppelin/contracts@5.0.2/access/manager/AccessManaged.sol
...
// File: contract-e8425e88a5.sol

/*
https://buzzme.biz.id/

BUZZME Tokens is a revolutionary support token specifically designed to bring the world of entertainment, chat rooms and private chats to life. We are committed to creating a dynamic digital ecosystem where users can enjoy unlimited entertainment while staying connected to the global community through our secure and innovative platform.
*/
...
/// @custom:security-contact support@buzzme.biz.id
contract BUZZME_Chat_Room_And_Private_Chat is ERC20, ERC20Burnable, ERC20Pausable, AccessManaged, ERC20Permit, ERC20FlashMint {
    constructor(address initialAuthority)
        ERC20("BUZZME", "BuzzMe")
