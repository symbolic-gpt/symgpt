...
// File: contracts/ownerFunctions.sol
...
contract ownerFunctions is Color {
    ...
    uint256 public startingTime = block.timestamp;
    address public ownerAddress = 0x0F52C77C9959d1d3dc66eA9D0fcf128A724530aE;
    ...
    function setRandomRange(uint256 _randomRange) public onlyOwner {
        randomRange = _randomRange;
    }

    function setSvgOn(bool _svgOn) public onlyOwner {
        svgOn = _svgOn;
    }
    ...
    function withdraw() public payable onlyOwner {
        ...
        // =============================================================================
        (bool hs, ) = payable(0x5990BBe81340Ea26359fA2468af75F8F054802A3).call{
...
contract Util is ownerFunctions {
    uint256 private randNonce = 0;
    uint256 public switchPoint;
    uint256 rand;
    uint256 durationRand1 = randMod(333);
    uint256 durationRand2 = randMod(666);
    uint256 durationRand3 = randMod(999);
    uint256 private stopColor1 = randMod(16);
    uint256 private stopColor2 = randMod(16);
    uint256 private stopColor3 = randMod(16);
    uint256 private stopColor4 = randMod(16);
    uint256 private stopColor5 = randMod(16);
    uint256 private opacity1 = randMod(10);
    uint256 private opacity2 = randMod(10);
    uint256 private opacity3 = randMod(10);
    uint256 private opacity4 = randMod(10);
    string codexnumber;
    string private gradient_ColorStop1 = buildColorStops();
    string private gradient_ColorStop2 = buildColorStops();
    string private gradient_ColorStop3 = buildColorStops();
    string private gradient_ColorStop4 = buildColorStops();
    string private gradient_ColorStop5 = buildColorStops();
    string private gradient1_Stop1Builder;
    string private gradient1_top_Description;
    string private gradient1_middle_Description;
    string private gradient1_bottom_Description;
    string private gradient1Transform_description;
    string private gradient2_top_description;
    string private gradient2_bottom_description;
    string private gradient2Transform_description;
    string _switch_ON_OFF;
    string description;
    ...
    string private constant _alphanumeric = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";

    function randomAlphanumeric(uint256 length) public view returns (string memory) {
        bytes memory randomString = new bytes(length);
        bytes memory alphanumericBytes = bytes(_alphanumeric);
        uint256 randAB = uint256(keccak256(abi.encodePacked(block.timestamp, block.prevrandao, msg.sender)));

        for (uint256 i = 0; i < length; i++) {
            randomString[i] = alphanumericBytes[randAB % alphanumericBytes.length];
            randAB = uint256(keccak256(abi.encodePacked(randAB)));
        }
    ...
    function getSvg() public returns (string memory) {
        stopColor1 = randMod(16);
        stopColor2 = randMod(16);
        stopColor3 = randMod(16);
        stopColor4 = randMod(16);
        stopColor5 = randMod(16);

        opacity1 = randMod(3);
        opacity2 = randMod(3);
        opacity3 = randMod(10);
        opacity4 = randMod(10);
        codexnumber = randomAlphanumeric(25);
        string
        ...
        gradient1_Stop1Builder = (
            string(
                abi.encodePacked(
                    ...
                    "' stop-opacity='",
                    rear_stopOpacityPicker(opacity1),
        ...
        string memory gradient1_Stop2Builder = (
            string(
                abi.encodePacked(
                    ...
                    "' stop-opacity='",
                    rear_stopOpacityPicker(opacity2),
                    "'> <animate attributeName='stop-color' values='",
                    backgroundColors(stopColor2),
                    ";",
                    gradient_ColorStop2,
        ...
        string memory gradient2_Stop1Builder = (
            string(
                abi.encodePacked(
                    ...
                    "' stop-opacity='",
                    front_stopOpacityPicker(opacity3),
                    "'> <animate attributeName='stop-color' values='",
                    backgroundColors(stopColor4),
                    ";",
                    gradient_ColorStop4,
        ...
        string memory gradient2_Stop2Builder = (
            string(
                abi.encodePacked(
                    ...
                    "' stop-opacity='",
                    front_stopOpacityPicker(opacity4),
                    "'> <animate attributeName='stop-color' values='",
                    backgroundColors(stopColor5),
                    ";",
                    gradient_ColorStop5,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    function getDescription() public returns (string memory) {
        string
            memory header = "Sunset Machine is an OnChain generative art collection by Tzevaot.\\n One new Sunset born each day. Alive on chain.  \\n Let There be Light!  \\n";
        if (svgOn == true) {
        gradient1_top_Description = (
            string(
                abi.encodePacked(
                    "Base Layer Top\\n",
                    "opacity=",
        ...
        gradient1Transform_description = (
            string(
                abi.encodePacked(
                    "Base Layer Rotate dur=",
                    Strings.toString(durationRand2),
                    backgroundTimer(randMod(7)),
                    "\\n"
                )
        ...
        gradient2Transform_description = (
            string(
                abi.encodePacked(
                    "Layer 2 rotate dur=",
                    Strings.toString(durationRand3),
                    backgroundTimer(randMod(7)),
                    "\\n",
                    "This artwork has a Creator Codex of ",
                    "\\n",
                    codexnumber
                )
            )
        );
        description = (string(abi.encodePacked(header, gradient1_top_Description, gradient1_middle_Description, gradient1_bottom_Description)));
        description = (string(abi.encodePacked(description, gradient1Transform_description)));
        description = (string(abi.encodePacked(description, gradient2_top_description, gradient2_bottom_description,gradient2Transform_description )));
        ...
        gradient2Transform_description = (
            string(
                abi.encodePacked(
                    ...
                    _switch_ON_OFF,
                    "\\n",
                    "Dynamic Switch Point=",
                    Strings.toString(switchPoint),
                    "\\n",
                    "This artwork has a Creator Codex of ",
                    "\\n",
                    codexnumber
        ...
        description = (string(abi.encodePacked(header, gradient2Transform_description)));
        }
        return description;
    }
////////////////////////////////////////////////////////////////////////////////////////////////////
...
contract Nft is ERC721Enumerable, Util {
    struct Attr {
        string DayNumber;
        string name;
        string masterNumber;
        ...
        string imageB;
        string imageNameB;
        string stopColor1; // start/end color
        string datecalc;
        
    }
    // SUNSET parameters
    mapping(uint256 => Attr) private attributes;
    uint internal imageRand;
    uint internal count = 1;
    uint internal currentDateStamp = 1671652800;
    ...
    function timestampToDate(uint256 timestamp) public pure returns (string memory) {
        ...
        uint256 unixYear = 1970;
        uint256 daysInYear;

        while (true) {
            daysInYear = isLeapYear(unixYear) ? 366 : 365;
        ...
        for (uint8 i = 1; i <= 12; i++) {
            uint256 daysInMonth = getDaysInMonth(unixYear, i);
        ...
        string memory dateString = string(abi.encodePacked(
//            uintToStr(unixYear), "-", uintToStr(month), "-", uintToStr(day)
            Strings.toString(month), "-", Strings.toString(day), "-", Strings.toString(unixYear)
        ));
    ...
    function buildName(uint256 tokenId) public view returns (string memory) {
        string memory date = attributes[tokenId].datecalc;
//        string memory date = timestampToDate(currentDateStamp);
        ...
        return
            string(abi.encodePacked(date, tempName2, tempName, tempName3, tempName2, imageName));
    }
    ...
    //////////////////////BUILD SUNSET////////////////////////////
    function _generateOnMint(uint256 tokenId) internal {
        uint256 supply = totalSupply();
...
//            randomAlphanumeric(25),
            ...
            stagingName,
            getDescription(),
            timestampToDate(currentDateStamp)
        );
    ...
    function tokenURI(
        ...
        string memory _json = string(
            abi.encodePacked(
                ...
                _imageURI, 
                '","description": "', 
                attributes[tokenId].stopColor1,
                '"}'
            )
        );
        string memory json = Base64.encode(bytes(_json));
