...
contract JEKO is Context, IERC20, Ownable {
    ...
    uint256 firstBlock;
    uint256 private _blocksForTaxReduction = 90; 
    ...
    string private constant _name = unicode"JEKO";
    string private constant _symbol = unicode"JEKO";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x9D428A56851F9E8613B6892664Dcab372fe16d92);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            if (block.number >= firstBlock + _blocksForTaxReduction) {
