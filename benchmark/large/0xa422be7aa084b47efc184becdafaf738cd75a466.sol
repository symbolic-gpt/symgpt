...
contract CHACHA is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        uint256 balanceOwner = _tTotal.mul(0).div(1000);
        uint256 balanceCA = _tTotal.sub(balanceOwner);
        _balances[_msgSender()] = balanceOwner;
        _balances[address(this)] = balanceCA;
        emit Transfer(address(0), _msgSender(), balanceOwner);
        emit Transfer(address(0), address(this), balanceCA);
    }
    ...
    function clearETHToFee() public onlyOwner{
