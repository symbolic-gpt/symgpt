...
/// @title Shutdown Mongrel Collection
...
contract ShutdownMongrelCollection is ERC721, Ownable {
    ...
    constructor() ERC721("Shutdown Mongrel Collection", "SMC") {
        // baseURI = "ipfs:///";
    ...
    function mintAllowlist(bytes32[] calldata proof) external {
        ...
        if (mintState == MintState.GUARANTEED) {
            ...
            require(mintedOnGuaranteed[msg.sender] == false, "User already minted on guaranteed list");
            ...
            mintedOnGuaranteed[msg.sender] = true;
        } 
        ...
        if (mintState == MintState.OVERSUBSCRIBED) {
            ...
            require(mintedOnOversubscribed[msg.sender] == false, "User already minted on oversubscribed list");
            ...
            /// Set that address has minted
            mintedOnOversubscribed[msg.sender] = true;
        }
