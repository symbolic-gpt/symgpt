...
/*
https://t.me/tgicoineth
https://tgi-maga.xyz/
https://x.com/realtgicoin
*/
...
contract TGI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trump Guardian Inu";
    string private constant _symbol = unicode"TGI";
    uint256 public _maxTxAmount =   8234123212 * 10**_decimals;
    uint256 public _maxWalletSize = 8234123212 * 10**_decimals;
    ...
    constructor () {
        ...
        _taxWallet = payable(0xE357C2692c7D54b792A669FFB841885a5A7702f2);
