...
contract AmericaPresident is Context, IERC20, Ownable {
    ...
    string private constant _name = "American Trump";
    string private constant _symbol = unicode"GODBLESS";
    uint256 public _maxTxAmount = 6310350000 * 10**_decimals;
    uint256 public _maxWalletSize = 8413800000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 420690000 * 10**_decimals;
    uint256 public _maxTaxSwap= 8413900000 * 10**_decimals;
    ...
    constructor () {
        _taxWallet = payable(0xb6FbADe2298A59887489BBde4A9335C49b729913);
