...
/// @title Reality Metaverse Genesis Collection
...
contract RealityMetaverseGenesisCollection is ERC721, Ownable {
    ...
    constructor() ERC721("Reality Metaverse Genesis Collection", "RMGC") {
        placeholderURI = "ipfs://QmQnBq4h78U4LihAeCUGFuUSnHGtGyzAc3rfB5NRAeJrUJ/";
    ...
    ///@notice Sets a new placeholder uri
    ///@dev Only callable by owner
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string.concat(baseURI, Strings.toString(tokenId), ".json") : placeholderURI;
    }
