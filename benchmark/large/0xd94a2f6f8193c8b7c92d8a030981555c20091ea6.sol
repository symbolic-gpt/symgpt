...
// File @openzeppelin/contracts/interfaces/IERC721.sol@v4.9.6
...
// File @openzeppelin/contracts/interfaces/IERC4906.sol@v4.9.6
...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721URIStorage.sol@v4.9.6
...
// File contracts/OVRLAY.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.17;
contract OVRLAY is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    event NFTMinted(uint256 tokenId, address recipient, string tokenURI);

    constructor() ERC721("OVRLAY", "OVRLAY") {}
