...
from audit.context import (ContractMetadata, SolContractERCAuditReport,
                           init_sol_audit_context)
    ...
    for idx, rule in enumerate(ei['rules']):
        ...
        if "interface" in rule and rule['interface'] != None and rule['interface'].strip().startswith('function'):
            ...
            for f in fns:
                ...
                except StateVarAnchorFnNotFound as ex:
