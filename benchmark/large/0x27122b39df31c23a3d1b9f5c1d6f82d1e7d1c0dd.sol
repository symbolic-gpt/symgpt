/*
    website  : https://truthtrump.xyz
    twitter  : https://x.com/truthtrumpceo
    telegram : https://t.me/truthtrumpchannel
*/
...
contract TRUMPWORLD  is Context, IERC20, Ownable {
    ...
    constructor(address payable _router) {
        sushiRouter = _router;
        _taxWallet = payable(0x5fc5E9B63668E1bF66d27f8c5EBE81dEe9DAC616);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!isTransfer && !_AMMPairs[to]) {
            takeFee = _isExcludedFromFee[from]
                ? false
                : shouldTrumpTakeFee(from, to, amount);
        }
    ...
    function withdrawTrumpStuckEth() external {
