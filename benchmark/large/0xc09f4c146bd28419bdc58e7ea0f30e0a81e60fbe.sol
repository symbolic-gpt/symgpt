...
In the enchanting realm of Pepe the Frog, there's a delightful character named Zeus who often goes unnoticed. Created by the imaginative artist Matt Furie, Zeus is far from a typical dog. 

Zeus represents Matt’s alter ego within the Pepe universe. Through Zeus, Matt channels his own distinct outlook on life, making him a beloved and whimsical figure in this colorful world.

With his charming quirks and lovable nature, Zeus adds an extra layer of magic and fun to the adventures of Pepe the Frog.

Telegram - https://t.me/ZeusByMattFurieETH

X - https://x.com/Zeus_Furie_ETH

Website - http://zeusbymatt.com/
...
contract ZEUS is ERC20, Ownable {
    ...
    string private constant _name = "Zeus by Matt Furie";
