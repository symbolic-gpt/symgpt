...
contract BLAZE is ERC20 ("BlazeTest", "BLAZE"), Ownable {
    ...
    IUniswapV2Router02(0xedf6066a2b290C185783862C7F4776A2C8077AD1);
    ...
    event UpdatedblazeWallet(address indexed newWallet);
    ...
    constructor(){
        ...
        maxSell = (totalSupply() * 20) / 1_000; 
        maxWallet = (totalSupply() * 20) / 1_000; 
        tokenSwapThreshold = (totalSupply() * 5) / 10_000;

        blazeWallet = msg.sender;
    ...
    function setblazeWallet(address _blazeWallet) external onlyOwner {
        require(_blazeWallet != address(0), "ERROR: _blazeWallet address cannot be 0");
        blazeWallet = payable(_blazeWallet);
        emit UpdatedblazeWallet(_blazeWallet);
    }
    ...
    function swapBack() private {
        ...
        (success, ) = address(blazeWallet).call{value: address(this).balance}("");
    }
