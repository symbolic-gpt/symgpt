...
contract ATT is ERC20, ERC20Burnable, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20(" ATT", "ATT")
        Ownable(initialOwner)
        ERC20Permit(" ATT")
    {
        _mint(msg.sender, 900777999777 * 10 ** decimals());
    }
