...
/*
Telegram: https://t.me/yellow_pepe_erc
Twitter: https://x.com/Yellow_pepe_erc
*/
...
contract YellowPepe is ERC20, Ownable {
    ...
    string private constant _name = "Yellow Pepe";
    string private constant _symbol = "YEYE";

    uint256 public initialTotalSupply = 6942694269*10**18;
    uint256 public maxTransactionAmount = 138853885*10**18;
    uint256 public maxWallet = 138853885*10**18;
    uint256 public swapTokensAtAmount = 69426942*10**18;
    ...
    function removeYeyeLimits() external onlyOwner {
