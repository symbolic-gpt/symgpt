/**
Dive into the captivating universe of $BONKU Token, where the magic of memes intertwines with the rich tapestry of Japanese traditions.

Web: https://bonkucoin.xyz/
X: https://x.com/BonkuOnEth
TG: https://t.me/BonkuOnETH
...
contract Bonku is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bonku";
    string private constant _symbol = unicode"BONKU";
