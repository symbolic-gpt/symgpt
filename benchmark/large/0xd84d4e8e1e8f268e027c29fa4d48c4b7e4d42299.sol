/**
https://x.com/TwiggyETH

https://twiggycoin.xyz

https://t.me/TwigPortal

Join the $TWIGGY World!
 */
...
contract TWIGGY is ERC20, Ownable {
    ...
    constructor() ERC20("Twiggy", "TWIGGY"){
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        marketingWallet = payable(0xa6AceE95d1857E345554610E357Bcc62EAd9eB0e);
    ...
    function addLpToUniswap() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0xa6AceE95d1857E345554610E357Bcc62EAd9eB0e,
            block.timestamp
        );
    ...
    function setNewestFee(uint256 _buyFee, uint256 _sellFee, uint256 _transferFee) external onlyOwner {
        sellFee = _sellFee;
        buyFee = _buyFee;
