...
/*
PENG-PENG -- THE CHINESE PENGUIN 0x00

https://t.me/pengpengtoken - 0x00
https://x.com/pengpengtoken 
https://www.peng-peng.xyz/ 
*/
...
contract peng is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Peng-Peng";
    string private constant _symbol = "PENG";
    uint256 public _maxTxAmount =   7206900000 * 10**_decimals;
    uint256 public _maxWalletSize = 7206900000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 7200000000 * 10**_decimals;
    uint256 public _maxTaxSwap= 7206900000 * 10**_decimals;
