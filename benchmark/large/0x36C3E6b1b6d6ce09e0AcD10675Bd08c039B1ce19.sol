...
contract BASETEST1 is ERC20("base-test", "BTS"), Ownable {
    ...
    function unstake() external {
        ...
        _transfer(address(this), msg.sender, s_balances[msg.sender]);

        STAKED_TOTAL_SUPPLY -= s_balances[msg.sender];
    ...
    function claimStakeRewards() public {
        ...
        require(rewards <= balanceOf(address(this)), "Amount exceeds bank total supply!");
