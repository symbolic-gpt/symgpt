...
/// @custom:security-contact conectabusiness.club
contract ConectaBusinessCoin is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("Conecta Business Coin", "CBC")
        Ownable(initialOwner)
        ERC20Permit("Conecta Business Coin")
    {
        _mint(msg.sender, 369369 * 10 ** decimals());
    }
