...
contract DulCoins_LaDESTRA is ERC20, ERC20Burnable, ERC20Pausable, AccessControl, ERC20Permit, ERC20FlashMint {
    ...
    constructor(address defaultAdmin, address pauser, address minter)
        ERC20("DulCoins", "DulCoins")
        ERC20Permit("DulCoins")
    ...
    // Fungsi ing ngisor iki overrides dibutuhake.
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        require(recipient != address(0), "ERC20: transfer menyang alamat nul");
