...
contract ELegalToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("eLegal Token", "ELT")
        Ownable(initialOwner)
        ERC20Permit("eLegal Token")
    {
        _mint(msg.sender, 369 * 10 ** decimals());
    }
