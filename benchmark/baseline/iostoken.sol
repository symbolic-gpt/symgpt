...
contract Token {
    // Removed totalSupply function to avoid conflict with state variable in IOSToken
...
returns (uint) {
    ...
    // uint public totalSupply; // Removed to avoid overriding state variable
}
...
contract IOSToken is UnboundedRegularToken {
    ...
    string public constant name = "IOSToken";
    string public constant symbol = "IOST";
