...
/*
https://t.me/michishotinear_portal
https://x.com/michishotinear
http://michishotinear.lol/
*/
...
contract MSIE is ERC20, Ownable {
    ...
    string private constant _name =unicode"Michi Shot In Ear";
    string private constant _symbol =unicode"MSIE";

    uint256 public initialTotalSupply = 420690000000 * 1e18;
    uint256 public maxTransactionAmount = 8413800000 * 1e18;
   ...
   function removeLimits() external onlyOwner {
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 20 && _sellFee <= 60, "Fees cannot exceed 40%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
