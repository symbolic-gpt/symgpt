...
abstract contract ERC20 {
    ...
    function transfer(address _to, uint _value) public virtual returns (bool ok);
...
abstract contract IST20 {
    function verifyTransaction(
        address _sender,
        address _reciver
    ) internal virtual returns (bool);

    function lockAccount(address _address) public virtual returns (bool);

    function unlockAccount(address _address) public virtual returns (bool);
...
returns (bool) {
    ...
    function transfer(address _to, uint _value) public override returns (bool ok) {
...
returns (bool ok) {
    ...
    function lockAccount(address _address) public override returns (bool) {
        require(msg.sender == owner);
        require(allowedAddress[allowedIndex[_address]]._address == _address);
    ...
    function unlockAccount(address _address) public override returns (bool) {
        require(msg.sender == owner);
        require(allowedAddress[allowedIndex[_address]]._address == _address);
