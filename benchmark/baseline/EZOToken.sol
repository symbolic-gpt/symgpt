...
abstract contract ERC20 {
    ...
    function balanceOf(address _who) public virtual view returns (uint);
...
contract EZOToken is ERC20, SafeMath, Haltable {
    ...
    receive() external payable {
        ...
        record.sender = payable(msg.sender);
        ...
        if (_uniqueId != systemAddress) {
            ...
            if (
                ...
                if (curAddress == address(0)) {
                    assignEther(payable(msg.sender), sentAmount);
                    if (returnAmount != 0) {
