...
contract HPT is ERC721, ERC721URIStorage, Ownable, ERC2771Context {
    uint256 private _nextTokenId;
    string public contractURI =
        "ipfs://QmZS71kjZAmX9xQkP2n7vgiJjqXddtH9caMGtGWPur4QQB/contract-metadata.json";
    ...
    constructor(
        ...
        ERC721("Ngo Vi Dong's Private Collection", "NFT")
    ...
    function batchSetTokenURI(
        ...
        uint256 urisLength = uris.length;
        require(
            urisLength == toTokenId - fromTokenId + 1,
