...
contract DogPlaysChild is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    
    uint256 private constant MINTING_INTERVAL = 15 days;
    uint256 private constant INITIAL_SUPPLY = 1000000000 * (10 ** 18);
    uint256 private constant MAX_SUPPLY = 1000000000 * (10 ** 18);
    uint256 private constant AIRDROP_SUPPLY = 0 * (10 ** 18);
    uint256 private AIRDROP_AMOUNT = 0 * (10 ** 18);
    uint256 private constant BASIS_POINTS_DIVISOR = 10000;
    uint256 private MINTING_REWARD_RATE = 0; // 1.0% in basis points
    ...
    constructor(address initialOwner) ERC20("Dog Play's Child Doll", "Chucky") Ownable(initialOwner) {
